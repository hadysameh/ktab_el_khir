                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('register') }}">
                            ...
                            <div class="form-group row">
                                <label for="password-confirm" class="col-md-4 col-form-label text-md-right">{{ __('نوع المستخدم') }}</label>
    
                                <div class="col-md-6">
                                    {{-- <input id="password-confirm" type="password" class="form-control" name="user_type" required autocomplete="new-password"> --}}
                                    <select name="user_type" id=""  class="form-control">
                                        <option value="1" selected>مستخدم عادي</option>
                                        <option value="2">مكتبه</option>
                                    </select>
                                </div>
                            </div>
